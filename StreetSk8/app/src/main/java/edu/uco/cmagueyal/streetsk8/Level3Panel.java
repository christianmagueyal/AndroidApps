...
public class Level3Panel extends SurfaceView implements SurfaceHolder.Callback{
    public static final int TARGETSCORE = 5000; // 50,000
    ...
    private ArrayList<TallBricks> cones;
    ...
    public Level3Panel(Context context){
        super(context);
...
//        }
    ...
    public void drawText(Canvas canvas){
        ...
        if(player.getPlaying() == false && levelCompleted){
            ...
            paint1.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
            canvas.drawText("Level  3 Completed", WIDTH/2 - 55, HEIGHT - 250, paint1);
        }
    }
