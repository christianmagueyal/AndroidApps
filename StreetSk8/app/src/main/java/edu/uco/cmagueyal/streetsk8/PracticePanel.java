...
public class PracticePanel extends SurfaceView implements SurfaceHolder.Callback{

    public static final int TARGETSCORE = 3500; // 15,000
    ...
    public PracticePanel(Context context){
        super(context);
        getHolder().addCallback(this);
        setFocusable(true);
        PracticePanel.MyGestureDetector myGestureDetector = new PracticePanel.MyGestureDetector();
      ...
      ///          levelCompleted = true;
       ...
       //     }
            ...
            for (int i = 0; i < cones.size(); i++) {
                ...
                if (collision(cones.get(i), player)) {
                    cones.remove(i);
...
class MyGestureDetector implements GestureDetector.OnGestureListener {
    ...
    public void drawText(Canvas canvas){
        ...
        if(player.getPlaying() == false && levelCompleted){
            ...
            paint1.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
            canvas.drawText("Practice Completed", WIDTH/2 - 55, HEIGHT - 250, paint1);
        }
    }
